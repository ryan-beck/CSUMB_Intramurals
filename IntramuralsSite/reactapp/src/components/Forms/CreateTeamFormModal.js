				...
				>
					<View style={styles.centeredView}>
			            <View style={styles.modalView}>
			            	<CreateTeamForm handleFormSubmit={this.handleFormSubmit} leagueId={this.state.leagueId} user={this.state.user} playerExists={this.props.playerExists} modalVisible={this.setModalVisible}/>
			              	<Pressable
